\hypertarget{group__her2k__batch}{}\section{her2k\+\_\+batch\+: Batched hermitian rank 2k update}
\label{group__her2k__batch}\index{her2k\+\_\+batch\+: Batched hermitian rank 2k update@{her2k\+\_\+batch\+: Batched hermitian rank 2k update}}
...
\index{her2k\+\_\+batch\+: Batched hermitian rank 2k update@{her2k\+\_\+batch\+: Batched hermitian rank 2k update}!blas\+\_\+cher2k\+\_\+batch@{blas\+\_\+cher2k\+\_\+batch}}
\index{blas\+\_\+cher2k\+\_\+batch@{blas\+\_\+cher2k\+\_\+batch}!her2k\+\_\+batch\+: Batched hermitian rank 2k update@{her2k\+\_\+batch\+: Batched hermitian rank 2k update}}
\subsubsection[{\texorpdfstring{blas\+\_\+cher2k\+\_\+batch(int group\+\_\+count, const int $\ast$group\+\_\+sizes, bblas\+\_\+enum\+\_\+t layout, const bblas\+\_\+enum\+\_\+t $\ast$uplo, const bblas\+\_\+enum\+\_\+t $\ast$trans, const int $\ast$n, const int $\ast$k, const bblas\+\_\+complex32\+\_\+t $\ast$alpha, bblas\+\_\+complex32\+\_\+t const $\ast$const $\ast$\+A, const int $\ast$lda, bblas\+\_\+complex32\+\_\+t const $\ast$const $\ast$\+B, const int $\ast$ldb, const float $\ast$beta, bblas\+\_\+complex32\+\_\+t $\ast$$\ast$\+C, const int $\ast$ldc, int $\ast$info)}{blas_cher2k_batch(int group_count, const int *group_sizes, bblas_enum_t layout, const bblas_enum_t *uplo, const bblas_enum_t *trans, const int *n, const int *k, const bblas_complex32_t *alpha, bblas_complex32_t const *const *A, const int *lda, bblas_complex32_t const *const *B, const int *ldb, const float *beta, bblas_complex32_t **C, const int *ldc, int *info)}}]{\setlength{\rightskip}{0pt plus 5cm}void blas\+\_\+cher2k\+\_\+batch (
...
)}\hypertarget{group__her2k__batch_gac4edc9f4c3f96b878e856a7aedba5d2d}{}\label{group__her2k__batch_gac4edc9f4c3f96b878e856a7aedba5d2d}
...
\hline
\mbox{\tt in}  & {\em B} & B is an array of pointers to matrices B\mbox{[}0\mbox{]}, B\mbox{[}1\mbox{]} .. B\mbox{[}batch\+\_\+count-\/1\mbox{]}. In i-\/th group each element B\mbox{[}j\mbox{]} is a pointer to a matrix B\mbox{[}j\mbox{]} of size ldb\mbox{[}i\mbox{]}-\/by-\/kb. If trans\mbox{[}i\mbox{]} = Bblas\+No\+Trans, kb = k\mbox{[}i\mbox{]}; if trans\mbox{[}i\mbox{]} = Bblas\+Conj\+Trans, kb = n\mbox{[}i\mbox{]}. batch\+\_\+count=\{i=1\}$^\wedge$\{group\+\_\+count\}group\+\_\+sizes\mbox{[}i\mbox{]}.\\
\hline
...
cher2k\+\_\+batch 
\end{DoxySeeAlso}
\index{her2k\+\_\+batch\+: Batched hermitian rank 2k update@{her2k\+\_\+batch\+: Batched hermitian rank 2k update}!blas\+\_\+zher2k\+\_\+batch@{blas\+\_\+zher2k\+\_\+batch}}
\index{blas\+\_\+zher2k\+\_\+batch@{blas\+\_\+zher2k\+\_\+batch}!her2k\+\_\+batch\+: Batched hermitian rank 2k update@{her2k\+\_\+batch\+: Batched hermitian rank 2k update}}
\subsubsection[{\texorpdfstring{blas\+\_\+zher2k\+\_\+batch(int group\+\_\+count, const int $\ast$group\+\_\+sizes, bblas\+\_\+enum\+\_\+t layout, const bblas\+\_\+enum\+\_\+t $\ast$uplo, const bblas\+\_\+enum\+\_\+t $\ast$trans, const int $\ast$n, const int $\ast$k, const bblas\+\_\+complex64\+\_\+t $\ast$alpha, bblas\+\_\+complex64\+\_\+t const $\ast$const $\ast$\+A, const int $\ast$lda, bblas\+\_\+complex64\+\_\+t const $\ast$const $\ast$\+B, const int $\ast$ldb, const double $\ast$beta, bblas\+\_\+complex64\+\_\+t $\ast$$\ast$\+C, const int $\ast$ldc, int $\ast$info)}{blas_zher2k_batch(int group_count, const int *group_sizes, bblas_enum_t layout, const bblas_enum_t *uplo, const bblas_enum_t *trans, const int *n, const int *k, const bblas_complex64_t *alpha, bblas_complex64_t const *const *A, const int *lda, bblas_complex64_t const *const *B, const int *ldb, const double *beta, bblas_complex64_t **C, const int *ldc, int *info)}}]{\setlength{\rightskip}{0pt plus 5cm}void blas\+\_\+zher2k\+\_\+batch (
\begin{DoxyParamCaption}
\item[{int}]{group\+\_\+count, }
\item[{const int $\ast$}]{group\+\_\+sizes, }
\item[{bblas\+\_\+enum\+\_\+t}]{layout, }
...
\item[{int $\ast$}]{info}
\end{DoxyParamCaption}
)}\hypertarget{group__her2k__batch_ga5a446eb5bdf3a533959c4f1fb2247973}{}\label{group__her2k__batch_ga5a446eb5bdf3a533959c4f1fb2247973}
Performs one of the batch Hermitian rank 2k operations
